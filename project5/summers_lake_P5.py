...
fileName = input()
(numLines,numFeatures,X) = getData(fileName)

#Get centroid file input
print("Enter the name of your centroid file: ")
fileName = input()
(numCentroids,centroidCoord) = getCentroids(fileName)
...
j = 0
numPoints = 0
#add all squared distances from cluster 1 points to centroid 1
